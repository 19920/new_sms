...
const usersData=[
    {id:1,title:"BC Materials",description:"3rd",addedBy:'Kadahizi',date:"2021-04-20"},
    {id:2,title:"0001",description:"3rd",addedBy:'John',date:"2021-04-20"},
...
const StudyMaterials = () => {
    ...
    return (
       <>
        ...
        <LinkContainer to={`/school/new-study-material`}>
    ...
    <h1 className="text-center pt-5">Student Materials</h1>
