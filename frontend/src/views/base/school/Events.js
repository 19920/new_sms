...
const usersData=[
    {id:1,title:"MAths",totalParticipants:30,addedBy:'Kadahizi',date:"2021-04-20",class:"4th",active:true},
    {id:2,title:"Physics",totalParticipants:20,addedBy:'John',date:"2021-04-20",class:"all",active:true,},
...
const Events = () => {
    ...
    <h1 className="text-center pt-5">Events</h1>
   ...
   <CInput id="text-input" name="text-input" placeholder="Search student by name" />
        ...
        <tr key={product.id}>
                    <td>{product.title}</td>
                    <td>{product.class}</td>
                    <td>{product.totalParticipants}</td>
                    <td>{product.date}</td>
